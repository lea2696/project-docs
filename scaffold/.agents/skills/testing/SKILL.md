...
Read: active plan from `{{PROJECT_DOCS_PATH}}/plans/`, `{{PROJECT_DOCS_PATH}}/context/CONVENTIONS.md` (testing section), `{{PROJECT_DOCS_PATH}}/context/KNOWN_ISSUES.md`, `{{PROJECT_DOCS_PATH}}/references/CRITICAL_FLOWS.md`
