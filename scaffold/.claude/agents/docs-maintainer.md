...
1. `{{PROJECT_DOCS_PATH}}/context/CURRENT_STATE.md` — current project state
2. `{{PROJECT_DOCS_PATH}}/references/REPO_MAP.md` — current structure
3. The active plan and session from `{{PROJECT_DOCS_PATH}}/plans/` and `{{PROJECT_DOCS_PATH}}/sessions/`
