...
2. `{{PROJECT_DOCS_PATH}}/context/CONVENTIONS.md` — follow code style and patterns
3. `{{PROJECT_DOCS_PATH}}/context/TECH_STACK.md` — use approved technologies
4. `{{PROJECT_DOCS_PATH}}/references/KEY_FILES.md` — know entry points and critical files
