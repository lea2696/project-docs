...
2. `context/CONVENTIONS.md` — testing conventions section
3. `context/KNOWN_ISSUES.md` — known fragile areas
4. `references/CRITICAL_FLOWS.md` — critical user journeys
